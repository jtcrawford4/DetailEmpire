...
class InventoryItems:ObservableObject{
    @Published var inventoryItems:[InventoryItem] = [
        InventoryItem(price:0,
                      ...
                      purchased: false, startingItem: true, speedMultiplier: 0, moneyMultiplier: 0, type: InventoryType.equipment, tier: InventoryItemTier.common),
...
//                      purchased: false, startingItem: true, speedMultiplier: 0, moneyMultiplier: 0, type: InventoryType.product),
        InventoryItem(price:11.99,
                      ...
                      purchased: false, startingItem: true, speedMultiplier: 0, moneyMultiplier: 0, type: InventoryType.product, tier: InventoryItemTier.common),
