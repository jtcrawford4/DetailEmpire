...
class StoreItems:ObservableObject{
    @Published var storeItems:[InventoryItem] = [
        InventoryItem(price:149.99,
                      ...
                      itemMultiplier: 0, type: InventoryItem.InventoryType.product),
        InventoryItem(price:149.99,
                      name:"Basic Polisher",
                      ...
                      itemMultiplier: 0.10, type: InventoryItem.InventoryType.equipment),
        InventoryItem(price:349.99,
                      ...
                      itemMultiplier: 0.30, type: InventoryItem.InventoryType.equipment)
    ]
}
